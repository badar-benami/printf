#include "main.h"
/**
 * get_print_func---chooses the appropriate function to carry out the task.
 * @s: debate identifier.
 * @index: the argument indentifier index.
